    ...
    <>
      ...
      <section className="full-width-split-screen slideUpFade">
        ...
        <div>
          ...
          <p className="lineHeightUp">
            Une animation procédurale
            <strong><em>JavaScript</em></strong>
            {' '}
            pouvant être contrôlée depuis le clavier.
          </p>
      ...
      <section className="full-width-split-screen slideUpFade">
        <div>
          ...
          <p className="lineHeightUp">
            ...
            <strong><em>Agile</em></strong>
            {' '}
            au sein d'une équipe de programmeurs
            à partir d’une base de code non-optimale préexistante.
          </p>
      ...
      <section className="full-width-split-screen slideUpFade">
        ...
        <div>
          ...
          <p className="lineHeightUp">
            Une animation simple codée en
            <strong><em>SVG (SMIL).</em></strong>
          </p>
